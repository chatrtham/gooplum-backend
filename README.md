...
### **Flows**
Automation workflows generated by Goopie(not Gummie) AI agent, using emerging agent engineering techniques like HITL, subagents, summarization, and virtual file system access, which allow users to create automations without any programming knowledge
