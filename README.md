...
- **Flows**: automation workflows generated by Goopie(not Gummie) AI agent, using emerging agent engineering techniques like HITL, subagents, summarization, and file system interactions, which allow users to create automations without any programming knowledge
- **Agents**: custom AI agents that can run flows, interact with external services that guMCP supports, and self-improve themselves over time from user interactions
